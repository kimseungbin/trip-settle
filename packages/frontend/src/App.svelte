<script lang="ts">
	...
	import ExpenseTracker from './components/pages/ExpenseTracker.svelte'
	import Onboarding from './components/pages/Onboarding.svelte'
	import Settings from './components/pages/Settings.svelte'
	import DevTools from './components/common/DevTools.svelte'
